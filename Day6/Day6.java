...
public class Day6 {
	public static void main(String[] args) throws IOException, InterruptedException {
		FileInputStream fis = new FileInputStream("./src/test/resources/DDT/Day6.properties");
		//step 2
		Properties p = new Properties();
		p.load(fis);
		
		FileInputStream excel = new FileInputStream(
		        "./src/test/resources/DDT/day6.xlsx");
		...
		String employeeId = String.valueOf((long) wb.getSheet("Sheet1").getRow(1).getCell(3).getNumericCellValue());
